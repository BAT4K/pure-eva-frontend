  ...
  return (
    <section className="relative overflow-x-hidden bg-[#FAFAF9]">
      ...
      <div className="relative px-6 pb-16 pt-32 md:px-12 md:pb-24 md:pt-40 lg:px-20 lg:pb-28 lg:pt-48">
        ...
        <div className="absolute -left-20 bottom-0 h-64 w-64 rounded-full bg-[#A5D6A7]/8 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <div className="mb-6 flex items-center justify-center gap-2">
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.25em] text-[#4DD0E1]">
              Pure Botanicals
            </span>
            <Leaf className="h-4 w-4 text-[#4DD0E1]" />
            <div className="h-px w-8 bg-[#B2EBF2]" />
          ...
          <h1 className="mx-auto max-w-4xl font-serif text-4xl leading-tight text-[#212121] md:text-5xl lg:text-6xl">
            Inside the
            <br />
            <span className="text-[#A5D6A7]">Urban Reset Gel Cleanser</span>
          </h1>
