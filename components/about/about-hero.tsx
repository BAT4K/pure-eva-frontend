  ...
  return (
    <section className="relative overflow-hidden bg-[#FFFFFF]">
      ...
      <div className="relative px-6 pb-24 pt-12 md:px-12 md:pb-32 lg:px-20 lg:pb-40 lg:pt-20">
        {/* Decorative elements */}
        <div className="absolute -right-20 top-0 h-96 w-96 rounded-full bg-[#34D399]/5 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <ScrollReveal delay={0.2}>
            <h1 className="mx-auto max-w-4xl font-serif text-4xl leading-tight text-[#212121] md:text-5xl lg:text-7xl">
              Beauty in Its
              <br />
              <span className="text-[#34D399]">Purest Form</span>
            </h1>
          </ScrollReveal>
          ...
          <div className="mx-auto mt-16 flex max-w-xs items-center justify-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <svg className="h-6 w-6 text-[#34D399]/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
