...
export function AboutHero() {
  return (
    <section className="relative overflow-hidden bg-[#FFFFFF]">
      ...
      <div className="relative px-6 pb-24 pt-[120px] md:px-12 md:pb-32 lg:px-20 lg:pb-40 lg:pt-[150px]">
        {/* Decorative elements */}
        <div className="absolute -right-20 top-0 h-96 w-96 rounded-full bg-[#A5D6A7]/5 blur-3xl" />
        <div className="absolute -left-20 bottom-0 h-80 w-80 rounded-full bg-[#4DD0E1]/5 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <div className="mx-auto mt-16 flex max-w-xs items-center justify-center gap-4">
            <div className="h-px flex-1 bg-gradient-to-r from-transparent to-[#A5D6A7]/30" />
            <div className="flex items-center gap-2">
              <svg className="h-6 w-6 text-[#A5D6A7]/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
            ...
            <div className="h-px flex-1 bg-gradient-to-l from-transparent to-[#A5D6A7]/30" />
          </div>
        </div>
      </div>
    </section>
