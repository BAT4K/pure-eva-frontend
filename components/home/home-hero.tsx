...
export function HomeHero() {
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#F7F4F0]">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <ScrollReveal delay={0.2}>
              <h1 className="mb-6 font-serif text-4xl leading-[1.1] text-[#2C2C2C] md:text-5xl lg:text-6xl xl:text-7xl">
                Reveal Your
                <br />
                <span className="text-[#B87A7A]">Natural Radiance</span>
              </h1>
            </ScrollReveal>

            <ScrollReveal delay={0.3}>
              <p className="mb-10 max-w-lg text-lg leading-relaxed text-[#2C2C2C]/60">
            ...
            <ScrollReveal delay={0.5}>
              <div className="mt-10 flex flex-wrap items-center gap-6 text-xs text-[#2C2C2C]/50">
          ...
          <div className="order-1 lg:order-2">
            <ScrollReveal delay={0.3}>
              <div className="relative">
                <div className="absolute -left-10 -top-10 h-48 w-48 rounded-full bg-[#B87A7A]/8 blur-3xl" />
                ...
                {/* Floating badge */}
                <div className="absolute left-6 top-6 rounded-full bg-white/90 px-4 py-2 text-xs font-medium tracking-wide text-[#A88B67] shadow-md backdrop-blur-sm">
                  New Collection
                </div>

                {/* Bottom accent */}
                <div className="absolute bottom-6 right-6 flex items-center gap-2 rounded-full bg-white/90 px-4 py-2 text-xs text-[#2C2C2C]/70 shadow-md backdrop-blur-sm">
                  <span className="h-2 w-2 rounded-full bg-[#B87A7A]" />
                  100% Natural
                </div>
                </div>
              </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#E5E0DA] to-transparent" />
    </section>
  )
}
